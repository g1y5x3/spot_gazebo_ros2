...
def generate_launch_description():
    ...
    pkg_project_description = get_package_share_directory('champ_description')
    pkg_ros_gz_sim = get_package_share_directory('ros_gz_sim')

    # Load the SDF file from "description" package
    sdf_file = os.path.join(pkg_project_description, 'models', 'champ', 'model.sdf')
